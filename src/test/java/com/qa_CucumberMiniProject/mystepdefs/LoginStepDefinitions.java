package com.qa_CucumberMiniProject.mystepdefs;
...
import com.pages_CucumberMiniProject.LoginPage;
...
public class LoginStepDefinitions {
    ...
    public void i_have_entered_a_valid_username_and_password() throws InterruptedException {
        loginPage.enterEmail("gaxylu@mailinator.com");
        loginPage.enterPassword("Pa$$w0rd!");
    }
